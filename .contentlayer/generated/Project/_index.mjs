...
import projects__iconsMdx from './projects__icons.mdx.json' assert { type: 'json' }
import projects__techxxyGithubIoMdx from './projects__techxxy.github.io.mdx.json' assert { type: 'json' }

export const allProjects = [projects__appleKeyboardMdx, projects__boilerplateDeploymentMdx, projects__documentationMdx, projects__fireupkoreanalphabetMdx, projects__iconsMdx, projects__techxxyGithubIoMdx]
